...
//   return (
//     <div className="fixed inset-0 z-0 bg-gradient-to-br from-blue-900/80 via-cyan-900/70 to-blue-700/60 overflow-y-auto">
//       <div className="min-h-screen flex flex-col items-center justify-start pt-8 px-4">
//         <div className="w-full max-w-3xl mx-auto glass-ios26 p-8 rounded-3xl shadow-2xl mb-8">
...
//         <h2 className="text-2xl font-bold text-white mt-4 mb-4">🌊 Public Ocean Activity Feed</h2>
//         <PostsFeed />
//       </div>
